...
require("lazy").setup({
  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    config = function()
      ...
      -- vim.keymap.set("n", ";ff", ":Telescope find_files<CR>", { desc = "[F]ile [B]roswer" })
      ...
      vim.keymap.set("n", "<leader>ls", "<cmd>Telescope lsp_document_symbols<cr>", { desc = "LSP: [S]ymobls" })
